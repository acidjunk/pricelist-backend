...
def upgrade():
    ...
    op.create_table('products_to_categories',
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('amount', sa.Integer(), nullable=True),
    sa.Column('product_id', postgresql.UUID(as_uuid=True), nullable=True),
    ...
    op.create_index(op.f('ix_products_to_categories_category_id'), 'products_to_categories', ['category_id'], unique=False)
    op.create_index(op.f('ix_products_to_categories_id'), 'products_to_categories', ['id'], unique=False)
    op.create_index(op.f('ix_products_to_categories_product_id'), 'products_to_categories', ['product_id'], unique=False)
